...
export class PoolTaskComponent {
    ...
    constructor(private host: ElementRef, private renderer: Renderer2, @Inject(DOCUMENT) private document: Document) {}
    ...
    public onMouseEnter(): void {
        ...
        this.tooltipTimeout = window.setTimeout(() => {
            ...
            let width = Math.min(rect.width, Math.max(100, window.innerWidth - margin * 2));
            let left = rect.left;
            ...
            setTimeout(() => {
                if (this.tooltipEl) this.renderer.addClass(this.tooltipEl, 'tooltip-visible');
            }, 10);
    ...
    public onMouseLeave(): void {
        ...
        if (this.tooltipEl) {
            ...
            setTimeout(() => {
                try { this.renderer.removeChild(this.document.body, this.tooltipEl!); } catch(e) {}
