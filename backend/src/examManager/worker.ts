...
self.onmessage = async (e: MessageEvent) => {
  ...
  try {
    ...
    if (type === "student") {
      ...
      const pdfPathDE =
        `${outputDir}/student_pdfs/${student.sequenceNumber}_${student.matriculation}_DE.pdf`;
      ...
      const pdfPathEN =
        `${outputDir}/student_pdfs/${student.sequenceNumber}_${student.matriculation}_EN.pdf`;
